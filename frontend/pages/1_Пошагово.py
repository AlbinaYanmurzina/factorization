    ...
    with col2:
        algo_choice = st.selectbox(
            ...
            [
                ...
                "Метод Ферма (разд. 3.1)",
                "(p+1)-метод Вильямса (разд. 3.3)",
                "Факторизация непрерывными дробями (разд. 3.6)",
                "Метод квадратичных форм SQUFOF (разд. 3.8)",
                "Алгоритм Диксона (Basic QS, разд. 6.1)",
                "Метод Померанца (Sieving QS, разд. 6.2)",
                "Квадратичное решето (Auto-tuning, разд. 6.5)",
                "Вариация большого множителя (LPV, разд. 6.8)",
                "Множество полиномов Монтгомери (MPQS, разд. 6.9)",
                "Параллельный MPQS (multiprocessing, разд. 6.9)",
            ]
        )
...
IS_QS_OR_CFRAC = {
    "qs_basic", "qs_optimized", "qs_auto", "qs_lpv",
    "qs_mpqs", "qs_mpqs_parallel", "cfrac",
}
